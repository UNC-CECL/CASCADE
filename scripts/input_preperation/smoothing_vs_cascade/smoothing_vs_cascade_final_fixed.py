...
# --- Output ---
OUTPUT_DIR = r"C:\Users\hanna\PycharmProjects\CASCADE\scripts\input_preperation\smoothing_vs_cascade\test_1984_2004"

# ============================================================
# CASCADE MODEL OUTPUT CONFIG
# ============================================================
# Point each entry to the shoreline_change_rate CSV produced by
# HAT_hindcast_1984_2024.py (one CSV per run, inside the per-run folder).
...
def load_cascade_rate(run_dict):
    """
    Load a CASCADE shoreline change rate CSV produced by HAT_hindcast_1984_2024.py.
