...
# This should be the folder containing the 'dunes' and 'topography' subfolders.
# IMPORTANT: Adjust this path to match your actual setup.
HATTERAS_BASE = os.path.join(r'C:\Users\hanna\PycharmProjects\CASCADE\data\hatteras_init')
...
def analyze_profile_pair(base_dir, file_num, data_year):
    """
    Loads and analyzes the dune file and the full topography file for a single domain,
