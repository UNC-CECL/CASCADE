...
if __name__ == "__main__":
    ...
    INPUT_FILEPATH = r'/data/hatteras_init/roads/offset/1978_road_setback_CLEAN.csv'

    # Define the path where you want the NEW filtered file to be saved
    OUTPUT_FILEPATH = r'/data/hatteras_init/roads/offset/1978_road_setback_FINAL.csv'
