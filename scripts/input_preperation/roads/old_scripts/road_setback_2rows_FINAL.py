...
INPUT_FILE_NAME = r'/data/hatteras_init/roads/offset/1978_road_setback_FINAL.csv'
OUTPUT_FILE_NAME = r'/data/hatteras_init/roads/offset/1978_road_setback_2row_FINAL.csv'
ID_COLUMN = 'domain_id'
