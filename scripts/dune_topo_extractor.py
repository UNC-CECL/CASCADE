...
# --- USER PATHS --------------------------------------------------------------
LOAD_PATH       = r"/Users/rsahrae/PycharmProjects/PeaIsland_Hindcast/CASCADE/data/2011_modified_RSLR"   # folder with *resampled*.npy
TOPO_SAVE_PATH  = r"/Users/rsahrae/PycharmProjects/PeaIsland_Hindcast/CASCADE/data/PeaIsland_init/Topo/2011_modified"
DUNE_SAVE_PATH  = r"/Users/rsahrae/PycharmProjects/PeaIsland_Hindcast/CASCADE/data/PeaIsland_init/Dunes/2011_modified"

os.makedirs(TOPO_SAVE_PATH, exist_ok=True)
os.makedirs(DUNE_SAVE_PATH, exist_ok=True)

# --- CONSTANTS (Pea Island) ----------------------------------------------------
MHW_M             = 0.36   # meters (NAVD88)
...
def process_domain_file(in_path: Path, topo_out_dir: Path, dune_out_dir: Path) -> None:
    ...
    topo_out = Path(topo_out_dir) / f"{stem}_topography.npy"
    dune_out = Path(dune_out_dir) / f"{stem}_dune.npy"
