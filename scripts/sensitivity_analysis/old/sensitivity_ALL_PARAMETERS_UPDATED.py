...
for i_list in range(START_REAL_INDEX, END_REAL_INDEX):  # real domains
    ...
    DUNE_FILE_PATHS.append(
        os.path.join(HATTERAS_DATA_BASE, 'dunes', '2009_v1', f'domain_{file_num}_dune_2009.npy'))
    ELEVATION_FILE_PATHS.append(
        os.path.join(HATTERAS_DATA_BASE, 'topography', '2009_v1', f'domain_{file_num}_topography_2009.npy'))
