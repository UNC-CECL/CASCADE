...
This script compares CASCADE model comparison to DSAS observations at each domain
...
# Path to CASCADE comparison from your baseline run
...
# Output directory
OUTPUT_DIR = os.path.join(PROJECT_BASE_DIR, 'comparison', 'spatial_analysis')
...
# Load CASCADE model comparison
print("\n2. Loading CASCADE model comparison...")
