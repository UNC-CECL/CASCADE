...
def main():
    ...
    # Create ONE main output folder for this entire sensitivity run
    timestamp = datetime.now().strftime('%Y%m%d_%H%M%S')
    MAIN_OUTPUT_DIR = os.path.join(PROJECT_BASE_DIR, 'output', 'sensitivity_analysis', f'sensitivity_run_{timestamp}')
