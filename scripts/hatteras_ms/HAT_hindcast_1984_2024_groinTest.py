...
# 1967-1997 test.
GROIN_MODULE_IMPORT_PATH = "scripts.groin_module.hindcast_groin_test.version_control.HAT_groin_module"
...
TOPO_DUNE_SUBFOLDER = "2009"    # subfolder under topography/ and dunes/
