...
DUNE_OFFSET_FILE_1984 = os.path.join(
    ...
    "island_offset",
    "hindcast_1984_2004",
    f"Island_Dune_Offsets_1984_2004_PADDED_{TOTAL_DOMAINS}.csv",
)
DUNE_OFFSET_FILE_2004 = os.path.join(
    HATTERAS_DATA_BASE,
    "island_offset",
    "hindcast_2004_2024",
    f"Island_Dune_Offsets_2004_2024_PADDED_{TOTAL_DOMAINS}.csv",
)
...
STORM_FILE_2004_2024 = os.path.join(
    HATTERAS_DATA_BASE, "storms", "hindcast_storms", "storms_2004_2024.npy"
)
