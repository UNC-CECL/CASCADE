...
# --- Physical Parameters ---
SEA_LEVEL_RISE_RATE = 0.004  # m/yr - Adjust for different SLR scenarios
...
if START_YEAR == 1978:
    ...
    RUN_NAME = f'HAT_{START_YEAR}_{START_YEAR + RUN_YEARS}_constantbuffers'
