...
# --- Physical Parameters ---
SEA_LEVEL_RISE_RATE = 0.005  # m/yr - Adjust for different SLR scenarios
...
if START_YEAR == 1978:
    ...
    RUN_NAME = f'HAT_{START_YEAR}_{START_YEAR + RUN_YEARS}_natural'
...
# Currently set to all 0, then will modify...
# Domains 0-14: Left buffer (0.0)
# Domains 15-104: Real island
...
BACKGROUND_EROSION_RATES = [
     ...
     0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  # Domains 10-19
     0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  # Domains 20-29
     0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  # Domains 30-39
     0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  # Domains 40-49
     0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  # Domains 50-59
     0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  # Domains 60-69
     0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  # Domains 70-79
     0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  # Domains 80-89
     0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  # Domains 90-99
     0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  0.0000,  # Domains 100-109
...
def run_cascade_simulation(
    ...
    try:
        cascade = Cascade(
            ...
            # Wave parameters
            wave_height=1,  # old value wave_height=1,
            wave_period=7,  # old value wave_period=7, --> Increase to 8-9 s (Atlantic swell-dominated)
            wave_asymmetry=0.8, # old value wave_asymmetry=0.8, --> Reduce to 0.55-0.60 (more bidirectional)
            wave_angle_high_fraction=0.2,   # wave_angle_high_fraction=0.2, --> # Increase to 0.3-0.4 (significant oblique waves)
