...
# --- USER PATHS --------------------------------------------------------------
LOAD_PATH       = r"/Hindcast/ArraysHindcast/Arrays"  # folder with *resampled*.npy
TOPO_SAVE_PATH  = r"/Hindcast/ArraysHindcast/PEA_2011"
DUNE_SAVE_PATH  = r"/Hindcast/ArraysHindcast/PEA_2011"
...
def main():
    ...
    names = sorted([n for n in os.listdir(load_dir) if n.endswith(".npy") ])
