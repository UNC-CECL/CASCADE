# ~******* CASCADE RUN SCRIPT ********~
# This script is configured to run a single simulation with 23 connected domains.
...
def alongshore_connected(
    ...
    """
    # --------- INITIALIZE ---------
    datadir = "/Users/rsahrae/PycharmProjects/FAll2024/PeaIsland/Hindcast/ArraysHindcast"  # Assumes data is in a 'data' subdirectory
    cascade = Cascade(
        datadir,
        name,
        storm_file='/Users/rsahrae/PycharmProjects/FAll2024/PeaIsland/CASCADE/data/dataset/cascade-default-storms.npy',
        elevation_file=elevation_file,
        dune_file=dune_file,
        parameter_file="/Users/rsahrae/PycharmProjects/FAll2024/PeaIsland/Hindcast/ArraysHindcast/barrier3d-NoMngment-parameters.yaml",
        wave_height=1,
        wave_period=7,
        wave_asymmetry=0.8,
    ...
    # --------- SAVE ---------
    save_directory = "/Users/rsahrae/PycharmProjects/FAll2024/PeaIsland/Hindcast/ArraysHindcast/Output"
...
if __name__ == "__main__":
    ...
    number_of_domains = 42  # For your domains 78 through 100

    # Set the parameters for the simulation run
    simulation_time = 5  # Number of years to run
    output_name = "Connected_PeaIsland_Domain17to59_Natural_Run"
    storm_file_name = "/Users/rsahrae/PycharmProjects/FAll2024/PeaIsland/Hindcast/ArraysHindcast/cascade-default-storms.npy"  # IMPORTANT: Change to your actual storm file name
    ...
    elevation_file = [f"domain_{i}_topography.npy" for i in range(17,59)]
    dune_file = [f"domain_{i}_dune.npy" for i in range(17,59)]
    ...
    alongshore_connected(
        nt=simulation_time,
        name=output_name,
        storm_file='/Users/rsahrae/PycharmProjects/FAll2024/PeaIsland/Hindcast/ArraysHindcast/cascade-default-storms.npy',
