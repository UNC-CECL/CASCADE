...
Raw_Data_Path = r'/Users/rsahrae/PycharmProjects/FAll2024/PeaIsland/Hindcast/1978_duneline_offset_raw.csv'
...
Datum_dune_offset_df.to_csv(
    r'/Users/rsahrae/PycharmProjects/FAll2024/PeaIsland/Hindcast/PeaIslandHindcastAttributes/Dune_1978_Offset_PeaIsland.csv',
    index=False
)
...
relative_dune_df.to_csv(
    r'/Users/rsahrae/PycharmProjects/FAll2024/PeaIsland/Hindcast/PeaIslandHindcastAttributes/Relative_Dune_1978_Offset_PeaIsland.csv',
    index=False
)
...
pd.DataFrame(Relative_dune_offset_DM).to_csv(
    r'/Users/rsahrae/PycharmProjects/FAll2024/PeaIsland/Hindcast/PeaIslandHindcastAttributes/Relative_Dune_1978_Offset_DM_PeaIsland.csv',
    index=False,
    header=False
)
