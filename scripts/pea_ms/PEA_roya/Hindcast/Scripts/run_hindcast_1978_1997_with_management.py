...
# ------------------------------
run_name = 'Hindcast_PeaIsland_1978_1997'
...
s_file = '/Users/rsahrae/PycharmProjects/FAll2024/PeaIsland/Hindcast/HAT_1978_2022_Final_Hindcast_Storms.npy'

# ------------------------------
# Define island configuration and input file paths
# ------------------------------

buffer_enabled = False  # Enables domain buffers at both ends for alongshore transport

island_grid_number = 42        # Number of actual model domains for Hatteras (not including buffers)
...
dune_load_name = r'/Users/rsahrae/PycharmProjects/FAll2024/PeaIsland/Hindcast/PeaIslandHindcastAttributes/Relative_Dune_1978_Offset_PeaIsland.csv'  # Made with the script 'calculate_shoreline_position_dunes.py'
...
for i in range(0, 15):
    dune_name = '/Users/rsahrae/PycharmProjects/FAll2024/PeaIsland/Hindcast/sample_1_dune.npy'
    elev_name = '/Users/rsahrae/PycharmProjects/FAll2024/PeaIsland/Hindcast/sample_1_topography.npy'
...
for i in range(17, 59):  # Domain IDs 1–92 (inclusive)
    dune_name = f'/Users/rsahrae/PycharmProjects/FAll2024/PeaIsland/Hindcast/ArraysHindcast/Dunes/domain_{i}_dune.npy'
    elev_name = f'/Users/rsahrae/PycharmProjects/FAll2024/PeaIsland/Hindcast/ArraysHindcast/Topo/domain_{i}_topography.npy'
...
def alongshore_connected(
    ...
    # --- Elevation and dune topography_dunes ---
    elevation_file,                    # List of .npy files (one per domain) with topography_dunes
