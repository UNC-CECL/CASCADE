...
END_REAL_DOMAIN_INDEX = 42  # Exclusive index
START_FILE_NUMBER = 17      # Corresponds to the first domain file ID (e.g., domain_30...)

# Road Affected Indices (incorrect number)
START_ROAD_INDEX = 17
END_ROAD_INDEX = 18
...
PROJECT_BASE_DIR = r'/'
HATTERAS_DATA_BASE = os.path.join(PROJECT_BASE_DIR, 'PEA_roya', 'Hindcast')
OUTPUT_BASE_DIR = os.path.join(PROJECT_BASE_DIR, 'PEA_roya', 'output')

# Input data file paths
DUNE_LOAD_ALL = os.path.join(HATTERAS_DATA_BASE, 'Island_offset', 'Dune_Offsets_1978_1997_PADDED_72.csv')
STORM_FILE_1978_1997 = os.path.join(HATTERAS_DATA_BASE, 'Storms', 'storms_1978_1997.npy')
STORM_FILE_1997_2022 = os.path.join(HATTERAS_DATA_BASE, 'Storms', 'storms_1997_2019.npy')
...
if START_YEAR == 1978:
    ...
    RUN_NAME = 'PeaIsland_1978_1997_Natural_State'
...
for i_list in range(START_REAL_DOMAIN_INDEX, END_REAL_DOMAIN_INDEX):
    ...
    dune_path_template = os.path.join(HATTERAS_DATA_BASE, 'PEA_2011', f'domain_{file_num}_dune.npy')
    DUNE_FILE_PATHS.append(dune_path_template)

    elev_path_template = os.path.join(HATTERAS_DATA_BASE, 'PEA_2011',
...
def alongshore_connected(
    ...
    datadir = r"C:\Users\hanna\PycharmProjects\CASCADE\PEA_roya\Hindcast"
    cascade = Cascade(
        datadir,
        name,
        ...
        dune_file=dune_file,
        parameter_file=r"/scripts/pea_ms/PEA_roya/Hindcast/PEA-CASCADE-parameters.yaml", # Default parameter file
        wave_height=1,
        wave_period=7,
        wave_asymmetry=0.8,
