...
def main():
    ...
    # ----------------------------------------------------------------------
    data_78 = {
        'path': r'/Users/rsahrae/PycharmProjects/FAll2024/PeaIsland/CASCADE/data/Hindcast/Island_offset/1978_duneline_offset_raw.csv',
        'year': 1978
    }
    data_97 = {
        'path': r'/Users/rsahrae/PycharmProjects/FAll2024/PeaIsland/CASCADE/data/Hindcast/Island_offset/1997_duneline_offset_raw.csv',
        'year': 1997
    }
    ...
    output_file = '/Users/rsahrae/PycharmProjects/FAll2024/PeaIsland/CASCADE/data/Hindcast/Island_offset/Dune_Offsets_1978_1997_CASCADE_Input.csv'
