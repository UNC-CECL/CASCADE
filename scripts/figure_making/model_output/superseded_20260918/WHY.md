# gif_plot_script.py, FIX_gif_plot_script_improved.py -- retired 2026-09-18

Two versions of an animation script from the 1978-1997 runs (Roya's
`HAT_1978_1997_SQ_noBE` and `HAT_1978_1997_SQ_withBE_Roya_Hs2p5`). Both
`chdir` into those run folders under `output/raw_runs/`, which no longer
