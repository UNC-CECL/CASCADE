...
def alongshore_connected(
    ...
    """
    # --------- INITIALIZE ---------
    datadir = "/Users/rsahrae/PycharmProjects/CASCADE_Coupling/CASCADE/data/Inlet_dataset"  # Assumes data is in a 'data' subdirectory
    cascade = Cascade(
        datadir,
        name,
    ...
    # --------- SAVE ---------
    save_directory = "/Users/rsahrae/PycharmProjects/CASCADE_Coupling/CASCADE/data/Inlet_dataset/Run_Output"
...
if __name__ == "__main__":
    ...
    number_of_domains = 24  # For your domains 78 through 100

    # Set the parameters for the simulation run
    simulation_time = 130  # Number of years to run
    output_name = "Connected_25_Domain_Inlet_Natural_Run"
    ...
    elevation_file = [f"barrier3d-default-elevation_{i}.npy" for i in range(1, 25)]
    dune_file = [f"dune_segment_{i}.npy" for i in range(1, 25)]
