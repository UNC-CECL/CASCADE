...
os.chdir(r'C:\Users\hanna\PycharmProjects\CASCADE\output\raw_runs\Whole_HAT_1978_1997_Natural_State')
run_name = "Whole_HAT_1978_1997_Natural_State"
name_prefix = run_name
nt_run = 20 # Number of years to plot
number_barrier3d_models = 147 # Number of B3D domains to plot
Model_Grids_Of_Interest = range(0,147) # Specific B3D domains to plot
