...
READABLE_CSV = Path(str(_env.SUPERSEDED_STORMS / "testing_storms" / "base_storms" / "storms_2004_2024_readable.csv"))
...
# Output
# Was a drive-rooted path ending in "storm_check_2004_2024.png", used as a
