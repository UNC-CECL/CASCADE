...
READABLE_CSV = Path(r"/data/hatteras_init/storms/hindcast_storms/fixed_storms/storms_2004_2024_readable.csv")
...
OUTPUT_PATH = Path(r"/scripts/input_prep/storm_creation/storm_figures/comparison/storm_record_2004_2024_fixed.png")
SAVE_FIGURE = True
SHOW_FIGURE = True

# =============================================================================
# HISTORICAL STORM CATALOG  (1984–2004 only)
# =============================================================================
...
def match_storms(df, window_days):
...
def make_figure(df, match_results, begin_year, end_year):
    ...
    WINTER_C  = '#a8c4e0'   # soft steel blue
    HURR_C    = '#f4a261'   # warm sand orange
...
def main():
    ...
    df, match_res  = match_storms(df, MATCH_WINDOW_DAYS)
