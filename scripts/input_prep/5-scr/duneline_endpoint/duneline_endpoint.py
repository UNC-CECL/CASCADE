...
USAGE
    python scripts/input_prep/5-scr/duneline_endpoint/duneline_endpoint.py          # every window
    python scripts/input_prep/5-scr/duneline_endpoint/duneline_endpoint.py --windows 1996_2010
==============================================================================
"""
...
def build(start: int, end: int) -> dict:
    ...
    (out / "PROVENANCE.md").write_text("\n".join([
        ...
        "scripts/input_prep/5-scr/duneline_endpoint/duneline_endpoint.py.",
        "",
