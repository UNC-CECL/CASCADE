# =============================================================================
# SNAPSHOT -- DO NOT EDIT, DO NOT IMPORT.
# =============================================================================
# Read-only copy of the module the hindcast actually runs:
#     scripts/cascade_pipeline/coastsat_loess.py
# taken at commit 058cc821 (2026-08-19). Kept here so this stage shows the method it
# ended on. Edit the live module, then refresh this copy (see ../README.md).
#
# This banner is the ONLY difference from the live file. To check for drift,
# from scripts/input_prep/6-scr-smooth:
