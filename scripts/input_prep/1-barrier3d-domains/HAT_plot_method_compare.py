...
FIG_DIR = insert_figures_dir(PRODUCT, "4-result")
...
def main() -> None:
    ...
    fp = pd.read_csv(SCOPE / "footprint_1984_by_domain.csv").set_index("domain").loc[d]
    n = int(fp["n_cells"])
    ...
    p = FIG_DIR / f"HAT_method_compare_{args.base}_v3_GIS{d}.png"
