# This python script is used in ArcGis Pro - not in Pycharm!
# Script to export clipped and resampled rasters from ArcGIS Pro to .npy NumPy arrays
# Updated to match comparison format of the CASCADE Clip & Resample Domains tool
...
root_foimpolder = r'""C:\Users\hanna\OneDrive - University of North Carolina at Chapel Hill\Ch1_CASCADE_hatteras\Hatteras_CASCADE_Input\1-barrier3d-domains\2009-domain-clipresample""'

# Set the folder where .npy arrays will be saved
save_path = r'"C:\Users\hanna\OneDrive - University of North Carolina at Chapel Hill\Ch1_CASCADE_hatteras\Hatteras_CASCADE_Input\1-barrier3d-domains\2009-npy-arrays"'
