# Test changes made for beach nourishment or specific model run changes
...
#run_name_batch.append('OCR_IH_Nourishment_S0_Erosional_Sink_Test_N1')
#run_name_batch.append('OCR_IH_Nourishment_S0_Erosional_Sink_Test_N2')
#run_name_batch.append('OCR_IH_Nourishment_S0_Erosional_Sink_Test_N3')
#run_name_batch.append('OCR_IH_Nourishment_S0_Erosional_Sink_Test_N4')
#run_name_batch.append('OCR_IH_Nourishment_S0_Erosional_Sink_Test_N5')
#run_name_batch.append('OCR_IH_Status_Quo_S0_Erosional_Sink_Test_N1')

Sink_Name = ['Accretion']

def Process_Batch(Names,
                  Sink_Name,
                  Save_Path):
    name_list = Names
...
def Calculate_Island_Interior_Width_Change(cascade, years_modeled, buffer_length, number_barrier3d_models):
    ...
    for ww in range(buffer_length, (number_barrier3d_models - buffer_length)):
...
All_Values_List = []
for l in range(len(run_name_batch)):
    Output_DF = Process_Batch(Names = run_name_batch[l],Sink_Name =Sink_Name[0],Save_Path = Save_Path)
    All_Values_List.append(copy.deepcopy(Output_DF))
...
plt.plot(domain_nums, (All_Values_List[7]['Mean_Shoreline_Change_Rate']), label = '4', color = '#d62728')
plt.plot(domain_nums, (All_Values_List[9]['Mean_Shoreline_Change_Rate']), label = '5', color = '#9467bd')
...
#plt.plot(domain_nums, LRR_97_20, label = 'Historic Change',color='grey')
plt.axhline(y = 0, color = 'k', linestyle = '--')
plt.plot(domain_nums, (All_Values_List[6]['Mean_Shoreline_Change_Rate']), label= '1',color='#1f77b4')
plt.plot(domain_nums, (All_Values_List[7]['Mean_Shoreline_Change_Rate']), label= '2',color='#ff7f0e')
plt.plot(domain_nums, (All_Values_List[8]['Mean_Shoreline_Change_Rate']), label = '3', color = '#2ca02c')
plt.plot(domain_nums, (All_Values_List[9]['Mean_Shoreline_Change_Rate']), label = '4', color = '#d62728')
plt.plot(domain_nums, (All_Values_List[10]['Mean_Shoreline_Change_Rate']), label = '5', color = '#9467bd')
plt.plot(domain_nums, (All_Values_List[11]['Mean_Shoreline_Change_Rate']), label = 'B', color = 'black')
...
All_Drown_Section = []
All_Drown_Domain = []
for h in range(len(All_Values_List)):
    Data = All_Values_List[h]
    Drown_Year = Data['Island_Drown_Year'][0]
    Drown_Section = Data['Island_Drown_Section'][0]
    Drown_Number = Data['Island_Drown_Domain'][0]
    All_Drown_Year.append(copy.deepcopy(Drown_Year))
    All_Drown_Section.append(copy.deepcopy(Drown_Section))
    All_Drown_Domain.append(copy.deepcopy(Drown_Number))
