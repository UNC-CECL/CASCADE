...
for storm_num in range(1, 101):
    ...
    cascade_b3d_only = Cascade(
        ...
        elevation_file="NCB-default-elevation-config{0}-damMHW.npy".format(config),  # if using different elevation file, change this before "-elevation.npy"
    ...
    cascade_outwash100 = Cascade(
        datadir,
        name="config{0}_outwash100_startyr1_interval{1}yrs_Slope0pt03_{2}".format(config, storm_interval, storm_num),
        elevation_file="NCB-default-elevation-config{0}-damMHW.npy".format(config),  # if using different elevation file, change this before "-elevation.npy"
        dune_file="NCB-default-dunes-config{0}-dam.npy".format(config),
        parameter_file="outwash-parameters.yaml",
        storm_file=overwash_storm,
    ...
    cascade_outwash50 = Cascade(
        datadir,
        name="config{0}_outwash50_startyr1_interval{1}yrs_Slope0pt03_{2}".format(config, storm_interval, storm_num),
        elevation_file="NCB-default-elevation-config{0}-damMHW.npy".format(config),  # if using different elevation file, change this before "-elevation.npy"
        dune_file="NCB-default-dunes-config{0}-dam.npy".format(config),
        parameter_file="outwash-parameters.yaml",
        storm_file=overwash_storm,
    ...
    cascade_outwash0 = Cascade(
        datadir,
        name="config{0}_outwash0_startyr1_interval{1}yrs_Slope0pt03_{2}".format(config, storm_interval, storm_num),
        ...
        house_footprint_y=20,
        beach_full_cross_shore=70,
        outwash_storms_file="outwash_storms_startyr_1_interval_{0}yrs.npy".format(storm_interval),
