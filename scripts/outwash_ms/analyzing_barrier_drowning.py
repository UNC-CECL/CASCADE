...
# # shoreline position array storm 1
# fig4 = plt.figure()
# plt.plot(shoreline_pos_array_b3d[0])
# plt.plot(shoreline_pos_array_100[0])
# plt.plot(shoreline_pos_array_50[0])
# plt.plot(shoreline_pos_array_0[0])
# plt.legend(["no outwash", "100%", "50%", "0%"])
# plt.ylabel("Shoreline Position (m)")
# plt.xlabel("Simulation Years")
#
# # shoreface slope array storm 1
# fig5 = plt.figure()
# plt.plot(shoreface_slope_array_b3d[0])
# plt.plot(shoreface_slope_array_100[0])
# plt.plot(shoreface_slope_array_50[0])
# plt.plot(shoreface_slope_array_0[0])
# plt.legend(["no outwash", "100%", "50%", "0%"])
# plt.ylabel("Shoreface Slope")
# plt.xlabel("Simulation Years")
#
# # avg interior height array storm 1
# fig6 = plt.figure()
# plt.plot(avg_int_height_array_b3d[0])
# plt.plot(avg_int_height_array_100[0])
# plt.plot(avg_int_height_array_50[0])
# plt.plot(avg_int_height_array_0[0])
# plt.legend(["no outwash", "100%", "50%", "0%"])
# plt.ylabel("Average Interior Elevation (m MHW)")
# plt.xlabel("Simulation Years")
#
# # avg interior width array storm 1
# fig7 = plt.figure()
# plt.plot(avg_int_width_array_b3d[0])
# plt.plot(avg_int_width_array_100[0])
# plt.plot(avg_int_width_array_50[0])
# plt.plot(avg_int_width_array_0[0])
# plt.legend(["no outwash", "100%", "50%", "0%"])
...
# ax2.legend(["no outwash", "100%", "50%", "0%"])
...
# ax3.legend(["no outwash", "100%", "50%", "0%"])
...
# ax4.legend(["no outwash", "100%", "50%", "0%"])
