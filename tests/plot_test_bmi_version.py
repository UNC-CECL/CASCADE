...
def run_1_100years(name=new_100_version):
    ...
    brie, barrier3d_15cores = CASCADE.initialize(name, wave_height, wave_period, asym_frac, high_ang_frac, slr, ny, nt,
                                                 rmin, rmax, datadir)
    # --------- LOOP ---------
...
def plot_500_diff(filename_old=v1_500yr, filename_new=new_500_version):
    ...
    # load new version
    os.chdir('/Users/KatherineAnardeWheels/PycharmProjects/CASCADE/Run_Output/BMI_Version_Tests')
