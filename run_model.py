...
slr = 0.002  # m/yr
ny = 12  # number of alongshore sections (6=3 km for testing AST, make 30 for inlets=15 km)
nt = 1500  # timesteps for 3000 morphologic years
...
#   - show A outcome, but any future conclusions need to come from averaging 20+ different storm scenarios
...
# --------- plot ---------
filename = name + '.npz'
os.chdir('/Users/katherineanarde/PycharmProjects/CASCADE/')
output = np.load(filename, allow_pickle=True)
b3d = output['barrier3d']
brie = output['brie']
brie = brie[0]
