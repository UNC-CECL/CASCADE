...
def plot_ElevAnimation_CASCADE(
        ...
        fig_size=None,
        fig_eps=False,
        show_domain_labels=True,  # New parameter to control domain labeling
    ...
    - Adds domain number labels at 10m intervals
    """
        ...
        for t in range(maxMGMT + 1):
            if 0 < t <= TMAX_SIM:
                ...
                _plot_frame(
                    ...
                    show_domain_labels, domain_label_interval, is_post_storm=True
                )
    ...
    for t in range(TMAX_SIM):
        ...
        _plot_frame(
            ...
            fig_size, fig_eps, name, BarrierLength, ny,
            show_domain_labels, domain_label_interval, is_post_storm=False
        )
    ...
    if show_domain_labels:
        ...
        for i in range(0, ny, domain_label_interval):
            ...
            if domain_center < xmax:
                ...
                actual_domain_num = i + 1  # Adjust if needed (based on setup)
...
os.chdir('/Users/rsahrae/PycharmProjects/CASCADE_Coupling/CASCADE/data/PeaIsland/Run_Output')
run_name = "Connected_PeaIsland_15_Domain_Natural_Run"
name_prefix = run_name
nt_run = 130  # Number of years to plot
number_barrier3d_models = 15  # Number of B3D domains to plot

# Define which domains to plot
# Option 1: Plot all domains
Model_Grids_Of_Interest = range(0, 15)

# Option 2: Plot only real domains (skip buffers)
# If buffers are indices 0-14 and 120-134, plot only 15-119:
# Model_Grids_Of_Interest = range(15, 120)
...
directory = "/Users/rsahrae/PycharmProjects/CASCADE_Coupling/CASCADE/data/PeaIsland/Run_Output"
TMax_Sim = nt_run
TMax_MGMT = [0] * ny
beach_management_ny = [False] * ny
roadway_management_ny = [False] * ny

# # Generate plots with domain labels
...
#     y_lim=None,  # Auto-calculate to show full island
#     z_lim=3.5,
#     fig_size=None,
#     fig_eps=False,
#     Model_Grids_Of_Interest=Model_Grids_Of_Interest,
#     show_domain_labels=True,  # Enable domain labels
#     domain_label_interval=10,  # Label every 10 domains
# )