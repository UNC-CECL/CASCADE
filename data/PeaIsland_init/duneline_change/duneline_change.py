...
dune1978 = pd.read_csv(
    r"/Users/rsahrae/PycharmProjects/CASCADE_Hannah/CASCADE/data/PeaIsland_init/Island_offset/1978_duneline_offset_raw.csv"
)
dune1997 = pd.read_csv(
    r"/Users/rsahrae/PycharmProjects/CASCADE_Hannah/CASCADE/data/PeaIsland_init/Island_offset/1997_duneline_offset_raw.csv"
)

# ---- 1. Aggregate each year to one value per domain (mean ORIG_LEN) ----
d78 = (
    dune1978.groupby("domain_id")["ORIG_LEN"]
    .mean()
    .reset_index()
...
d97 = (
    dune1997.groupby("domain_id")["ORIG_LEN"]
    .mean()
    .reset_index()
...
outpath = (
    r"/Users/rsahrae/PycharmProjects/CASCADE_Hannah/CASCADE/data/PeaIsland_init/duneline_change"
