...
`RoadSetback_1984_dunestart.csv` is the model-facing forcing: metres landward of **interior row 0** of the 1984-start extraction, measured on the **1978 NC-12 line** (`raw_offset/1978/`, masks `raster/1978/`).
