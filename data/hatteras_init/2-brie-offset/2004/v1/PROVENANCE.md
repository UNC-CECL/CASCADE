...
```
python scripts/input_prep/2-brie-offset/island_offset_hybrid.py --year 2004 --version v1 --raw-file data/hatteras_init/2-brie-offset/2004/v1/2004_duneline_offset_raw.csv
```
