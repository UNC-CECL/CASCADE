...
**`offset_1996_superseded_v2_vs_v1.png`.** Two builds of the 1996 island offset. (a) The unpadded offset each build hands the model, superseded_v2 in red and v1 in blue, each zeroed on its own most seaward domain. (b) The change in the dune line itself, v1 minus superseded_v2, measured from the shared offshore datum along the 100 m transects and averaged per 500 m domain; positive is landward. 32 of 90 domains differ by 0.5 m or more (mean over all domains -7.8 m; the largest, -66.2 m, at GIS 35). Both raw files were produced by the same shapely intersection, so the metre-scale station convention of the earlier ArcGIS export is not part of the difference.
