...
```
python scripts/input_prep/2-brie-offset/1-produce/island_offset_hybrid.py --year 1996 --version v1 --raw-file data/hatteras_init/2-brie-offset/1996/v1/1997_duneline_offset_raw.csv
```
