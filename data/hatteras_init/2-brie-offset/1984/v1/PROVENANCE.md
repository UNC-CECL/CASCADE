...
```
python scripts/input_prep/2-brie-offset/island_offset_hybrid.py --year 1984 --version v1 --raw-file data/hatteras_init/2-brie-offset/1984/v1/1984_duneline_offset_raw.csv
```
