...
`../CURRENT` = `v2` since this build.
 `hatteras_site_config._island_offset_file(2010)` resolves it; env `HAT_OFFSET_VERSION_2010` outranks the file for one run.

## Rebuild

```
python scripts/input_prep/2-brie-offset/1-produce/island_offset_hybrid.py --year 2010 --version v2 --raw-file data/hatteras_init/2-brie-offset/2010/v2/2009_duneline_offset_raw.csv
```
