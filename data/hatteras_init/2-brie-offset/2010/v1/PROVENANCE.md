...
```
python scripts/input_prep/2-brie-offset/1-produce/island_offset_hybrid.py --year 2010 --version v1 --raw-file data/hatteras_init/2-brie-offset/2010/v1/2009_duneline_offset_raw.csv
```
