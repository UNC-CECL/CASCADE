...
> **Moved 2026-09-19** from `4-comparisons/duneline_vs_coastsat/` into `shoreline_vs_duneline/net_change/` (see `../README.md`). The alongshore figures are now in METRES with the beach-width gap shaded, and a `1996_2024/` window was added; the m/yr statements below describe the figures as they were.
