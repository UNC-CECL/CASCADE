...
> **Moved 2026-09-19** from `4-comparisons/net_change_1996_2024/` into `shoreline_vs_duneline/net_change/chains/` (see `../../README.md`). The figure is now `net_change_chain_1996_2010_2024.png`, with the gap split into widened (solid) and narrowed (hatched).
