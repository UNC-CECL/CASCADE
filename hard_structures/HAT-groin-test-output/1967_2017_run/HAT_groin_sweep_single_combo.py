...
WETDRY_CHANGE_TABLE = os.path.join(
    hc.PROJECT_BASE_DIR, "scripts", "groin_module", "hindcast_groin_test",
...
def main():
    ...
    profile_dir = os.path.join(hc.PROJECT_BASE_DIR, "scripts", "groin_module",
                                "hindcast_groin_test", "sensitivity_sweep", "profiles")
