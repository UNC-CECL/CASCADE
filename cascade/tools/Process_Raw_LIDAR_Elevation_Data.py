...
def Process_Raw_Topo_Data(
    ...
    for j in range(len(NPY_Files_Array)):
        ...
        ProccesedIslandElevationMatrix = ProccesedIslandElevationMatrix * 0.1
        DuneHeightsVector = DuneHeightsVector * 0.1
...
Process_Raw_Topo_Data(
    raw_data_path=load_path_name,
