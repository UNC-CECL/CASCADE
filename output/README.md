...
| `comparisons/` | `HAT_relocation_comparison.py`, `scenario_grid.py`, `rate_windows.py`, the hindcast figure | cross-run figures and tables, one folder per question. Its README has the tracking rule |
