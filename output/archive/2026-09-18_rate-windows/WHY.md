# 2026-09-18_rate-windows - the rate_windows figures before the rename

The figure folders of `output/comparisons/rate_windows/` as they stood on
2026-09-18, just before the tree was renamed to `model_vs_observed/` (commit
bf9cd660). Old names: `coastsat/{means,loess}`, `duneline/{endpoint,
